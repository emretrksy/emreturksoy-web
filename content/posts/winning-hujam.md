...
body_en: |
    ...
    The theme dropped at midnight. We had 30 minutes to decide on a concept. Four actions. Everything else built around making those four feel great.

    ## Hour 4–24: Just Ship the Mechanics

    Movement first, everything else second. This is the only way to jam.
...
body_tr: |
    ...
    Dört hareket. Diğer her şey bu dördünü harika hissettirmeye yönelik.

    ## Saat 4–24: Sadece Mekaniği Çıkar

    Önce hareket, sonra her şey. Jam'in tek yolu bu.
